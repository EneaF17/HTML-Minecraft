                ...
                <div class="contenitoreLista">
                    ...
                    <div class="Listone">
                        <ul class="lista" style="list-style-type: none;">
                            ...
                            <li class="elementolista"><img src="../immagini/Anvil.webp" alt=""><a href="">Incudine</a></li>
                            <li class="letteralista"><h2>J</h2></li>
                            <li class="elementolista"><img src="../immagini/Jhonny.webp" alt=""><a href="">Jhonny</a></li>
                        ...
                        <ul class="lista lista--dx" style="list-style-type: none;">
                            ...
                            <li class="elementolista"><img src="../immagini/Ragno.webp" alt=""><a href="">Ragno</a></li>
                            <li class="elementolista"><img src="../immagini/Rame.webp" alt=""><a href="">Rame</a></li>
                            <li class="letteralista"><h2>S</h2></li>
                            <li class="elementolista"><img src="../immagini/Scudo.webp" alt=""><a href="">Scudo</a></li>
                            ...
                            <li class="elementolista"><img src="../immagini/Vaso.webp" alt=""><a href="">Vaso</a></li>
                            <li class="elementolista"><img src="../immagini/Vex.webp" alt=""><a href="">Vex</a></li>
                            <li class="elementolista"><img src="../immagini/vetro.webp" alt=""><a href="">Vetro</a></li>
                            <li class="letteralista"><h2>W</h2></li>
                            <li class="elementolista"><img src="../immagini/Warden.webp" alt=""><a href="">Warden</a></li>
                            <li class="letteralista"><h2>X</h2></li>
                            <li class="letteralista"><h2>Y</h2></li>
                            <li class="letteralista"><h2>Z</h2></li>
                            <li class="elementolista"><img src="../immagini/Zappa.webp" alt=""><a href="">Zappa</a></li>
                            <li class="elementolista"><img src="../immagini/Zucca.webp" alt=""><a href="">Zucca</a></li>
                        </ul>
                    </div>
                </div> 
