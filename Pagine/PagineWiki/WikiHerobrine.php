        ...
        <body>
            ...
            <div class="contenitorePulsanti">
                <ul class="Pulsanti" style="list-style-type: none;">
                    <li><a href="WikiFornace.php"><img src="../../immagini/FrecciaSx.png"alt=""></a></li>
            ...
            <div class="contenitoreWiki">
                ...
                <div class="ContenitoreTabella">
                    ...
                    <table class="tabellaWiki">
                        ...
                        <tr>
                            <th>Conosciuto come</th>
                            <td>Entitá malvagia</td> 
                        </tr> 
                    </table>
                </div>
                <div class="TestoWiki">
                    <p>Herobrine è il soggetto di una creepypasta creata dalla community. È diventato una delle maggiori icone di Minecraft, anche se non è mai esistito in nessuna versione di Minecraft.</p>
                    <p>La prima storia ed immagine di Herobrine mai pubblicata, così come la trasmissione in diretta di Brocraft, sono considerate canoniche. Tutto ciò che è stato pubblicato dopo questi due avvenimenti sono considerate adattamenti e variazioni fan-made.</p>
                    <div class="ContenitoreIndice">
                        <h2>Indice</h2>
                        <ol>
                            <li><a href="#Esistenza">Esistenza</a></li>
                            <li><a href="#Origini">Origini e Popolaritá</a></li>
                        </ol>
                    </div>
                    <h2 class="Sezione jumptarget" id="Esistenza">Esistenza</h2>
                    <p>Herobrine non esiste e non è mai esistito in Minecraft non moddato.</p>
                    <p>Non c'è riferimento a lui in tutto il codice sorgente, e non c'è nessun codice che permette ad un entità di fare come Herobrine. Non c'è nessuna generazione del terreno nel codice che permette di generare torce di pietrarossa, tunnel 2x2 o dungeon con trappole elaborate.</p>
                    ...
                    <p>È opinione diffusa che tutte le sue apparizioni nel fiume siano dipinti a rete o porte di ferro. i fotogrammi presi dal flusso indicano che era molto piatto rispetto al muro, rendendo i dipinti la causa probabile. Ciò indica che stavano utilizzando un pacchetto di texture HD specializzato, ma con texture a bassa risoluzione per tutti gli altri blocchi.</p>
                    <p>Da allora, c'è stato un enorme aumento della sua popolarità, spingendo Herobrine allo status di meme e rendendolo un'icona della comunità. Sono stati creati diversi mod, animazioni, opere d'arte e costruzioni di Herobrine.</p>
                </div>
            </div>
        </body>
        <footer>
